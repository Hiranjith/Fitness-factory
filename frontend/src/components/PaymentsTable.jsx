  ...
  return (
    <div className="flex flex-col mb-8">
      <div className="flex justify-between items-start mb-6">
        ...
        <button className="flex items-center gap-3 bg-surface border border-border hover:bg-bg transition-colors rounded-xl px-4 py-2 mt-1">
      ...
      <div className="flex flex-col gap-3">
        {data.map((row) => (
          <div key={row.id} className="bg-surface rounded-2xl p-4 flex items-center justify-between border border-border hover:border-text-secondary/30 transition-colors cursor-pointer">
  ...
  return (
    <div className="flex flex-col mb-8">
      <div className="flex justify-between items-start mb-6">
        ...
        <button className="flex items-center gap-2 bg-transparent border border-primary/50 text-primary hover:bg-primary/10 transition-colors rounded-xl px-4 py-2 mt-1">
      ...
      <div className="flex flex-col gap-3">
        {data.map((row, idx) => {
          ...
          return (
            <div key={idx} className="bg-surface rounded-2xl p-4 flex items-center justify-between border border-border hover:border-text-secondary/30 transition-colors cursor-pointer">
              <div className="flex items-center gap-4 md:gap-5">
